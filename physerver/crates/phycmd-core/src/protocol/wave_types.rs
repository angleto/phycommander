...
mod tests {
    ...
    #[test]
    fn id_round_trip() {
        // Layout: dac (0..1) | pwm (2..9) | dout (10..25) | din (26..41) | adc (42..53)
        ...
        assert_eq!(channel_id_from_name("pwm7"), Some(9));
        ...
        assert_eq!(channel_id_from_name("adc0"), Some(42));
        assert_eq!(channel_id_from_name("adc11"), Some(53));
